  ...
  const content = {
    en: {
      ...
      hero: {
        ...
        subheadline: <>A platform to discover and book creative activities near you.<br/><br/><span className="text-muted-foreground text-lg md:text-xl">Ceramics · Painting · Workshops · Crafts<br/>and much more.</span></>,
    ...
    es: {
      ...
      hero: {
        ...
        subheadline: <>Una plataforma para descubrir y reservar actividades creativas cerca de ti.<br/><br/><span className="text-muted-foreground text-lg md:text-xl">Cerámica · Pintura · Talleres · Artesanía<br/>y mucho más.</span></>,
